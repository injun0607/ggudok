...
public class QReview extends EntityPathBase<Review> {
    ...
    private static final long serialVersionUID = 1540218866L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QReview review = new QReview("review");

    public final com.alham.ggudok.entity.QBaseTimeEntity _super = new com.alham.ggudok.entity.QBaseTimeEntity(this);
