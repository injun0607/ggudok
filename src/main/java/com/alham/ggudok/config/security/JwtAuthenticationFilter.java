...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    public void checkRefreshTokenAndReIssueAccessToken(HttpServletResponse response, String refreshToken) {
        memberSecurityRepository.findByRefreshToken(refreshToken)
                .ifPresent(member -> {
     ...
     */
    private String reIssueRefreshToken(MemberSecurity memberSecurity) {
        String reIssuedRefreshToken = jwtService.createRefreshToken();
        memberSecurity.updateRefreshToken(reIssuedRefreshToken);
    ...
    public void checkAccessTokenAndAuthentication(HttpServletRequest request, HttpServletResponse response,
        ...
        jwtService.extractAccessToken(request)
                ...
                .ifPresent(accessToken -> jwtService.extractEmail(accessToken)
                        .ifPresent(loginId -> memberSecurityRepository.findMemberSecurityByLoginId(loginId)
     ...
     */
    public void saveAuthentication(MemberSecurity memberSecurity) {
//        String password = myUser.getPassword();
//        if (password == null) { // 소셜 로그인 유저의 비밀번호 임의로 설정 하여 소셜 로그인 유저도 인증 되도록 설정
//            password = PasswordUtil.generateRandomPassword();
//        }
        UserDetails userDetails = customLoadUserByUsername.loadUserByUsername(memberSecurity.getLoginId());
