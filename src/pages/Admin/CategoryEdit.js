...
//redux import
import { editCategory, setValidCategoryName, setValidCategoryEng, setCategoryName, setCategoryEng, setCategoryImage } from '../../redux/actions/admin/adminCategoryActions';
...
const CategoryEdit = () => {
  ...
  const fetchCategoryData = async () => {
    try {
      ...
      dispatch(setValidCategoryName(true));
      dispatch(setValidCategoryEng(true));
  } catch (error) {
  ...
  const handleImageUpload = async () => {
    try {
      if (categoryImage) {
        ...
        await dispatch(setCategoryImage(imageUrl));
