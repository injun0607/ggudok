const initialState = {
  reviews: [
    { userid: '1', username:'달달이', itemid: '1', itemname: '스마트비디오', star: 5, contents: '스마트비디오는 혁신적인 OTT(Over-The-Top) 구독 서비스 기업으로, 최신 영화, 드라마, TV 프로그램, 애니메이션 등 다양한 콘텐츠를 제공하여 고객들에게 풍부한 시청 경험을 선사합니다..',},
    { userid: '2', username:'해변의 달달이', itemid: '1', itemname: '스마트비디오', star: 3, contents: '우리가 낳은 사랑은 버려진다 그래 이별은 너와 나의 책임이야 사랑 앞에 우린 죄인이야 울지마 바보야 나 정말 괜찮아',},
